...
NSString *const kQuizResponseObjectIsFreezed = @"isFreezed";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        self.isFreezed = [self objectOrNilForKey:kQuizResponseObjectIsFreezed fromDictionary:dict];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:self.isFreezed forKey:kQuizResponseObjectIsFreezed];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.isFreezed = [aDecoder decodeObjectForKey:kQuizResponseObjectIsFreezed];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_isFreezed forKey:kQuizResponseObjectIsFreezed];
...
- (id)copyWithZone:(NSZone *)zone
{
    ...
    if (copy) {
        ...
        copy.isFreezed = [self.isFreezed copyWithZone:zone];
